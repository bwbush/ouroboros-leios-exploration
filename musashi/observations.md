...
### Addendum (2026-09-24): operator thread confirms a network-side cause for the Leios cutoff

This addendum corrects and extends the entry above without rewriting it; the original stands as the record of what the capture alone showed.

A `#team-leios` thread ([parent](https://input-output-rnd.slack.com/archives/C074AHSKJF7/p1790155441835149), Krzysztof Paprocki, 2026-09-23 09:24 UTC) independently reports that the **"centrifuge" — the scheduled transaction load generator — went down**, with its "last periodic activity ended at 2026-09-23 03:05:11 UTC." That is within **~42 seconds** of this node's last fresh EB (slot 1,393,469, 2026-09-23 03:04:29.659 UTC, voted 03:04:32.744). The load generator's operator (Jon Barber, icangroup) confirmed the outage and a nominal ~12:00 UTC restoration; by 2026-09-24 the target message reports it down again with "some activity … but no Leios ongoing." The full investigation and evidentiary chain are in [`slack-message-investigation.md`](./slack-message-investigation.md#claude-findings).

Two corrections to the entry above follow from that thread:
